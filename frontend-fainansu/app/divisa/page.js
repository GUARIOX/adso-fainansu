  ...
  return (
    <div className="bg-white min-h-screen flex items-center justify-center p-4">
      <div className="bg-gray-50 rounded-3xl shadow-md p-10 pt-20 w-full max-w-md">
        <h2 className="text-orange-500 text-2   xl font-bold text-center mb-4">CONFIGURACION INICIAL</h2>
        <div className="mb-4 pb-56 ">
        <select className="w-full sm:w-64 lg:w-96 py-2 px-4 rounded-md border border-gray-300" id="currency" name="currency">
            <option value="" selected>Elige Una Moneda</option>
        ...
        <div className="text-center text-sm mt-4">
          De esta manera podemos gestionar tus finanzas de una manera mas adecuada
        </div>
      </div>
    </div>
  )
